...
const Restaurant = () => {
  ...
  const filteredRestarurant = restaurantData.filter((hotel) => {
    return (
      (searchName
        ? hotel.restaurantName.toLowerCase().includes(searchName.toLowerCase())
        : true) &&
      (searchCategory
  ...
  return (
    <>
      {/* Page Heading */}
      <CustomHeading tittel="রেস্টুরেন্ট" />
      {/* Restarunt   Serching  */}
              ...
              >
                ...
                <div className="px-5 py-4 space-y-2">
                  ...
                  <p className="text-gray-600 text-sm">
                    🛏️ <strong> তথ্য:</strong> {item.restaurantInfo}
                  </p>
                  <p className="text-gray-600 text-sm">
